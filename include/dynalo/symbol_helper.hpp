...
// USAGE
//
//  DYNALO_EXPORT <return type> DYNALO_CALL <function name>(<function argument
//  types...>)
//
// EXAMPLE
//
...
//
//      DYNALO_EXPORT int32_t DYNALO_CALL add_integers(const int32_t a, const
//      int32_t b); DYNALO_EXPORT void DYNALO_CALL print_message(const char*
//      message);
//
//  IMPORTING FUNCTIONS
//
...
#else
#error                                                                         \
    "dynalo/symbol_helper.hpp Define either DYNALO_EXPORT_SYMBOLS or DYNALO_IMPORT_SYMBOLS"
#endif
